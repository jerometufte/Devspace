(function () {  // Module pattern
  ...
  App = (function(){
    function App(){
      ...
      this.radialController = new RadialController(this);
    };
  ...
  RadialController = (function(){
    
    function RadialController(app) {
      this.app = app;
      this.gesture = app.gesture
    ...
    RadialController.prototype.init = function() {
      var _this = this
      var radialHTML = '<div id=\"radial-menu\"><ul><li class=\"radial\" id=\"radial1\"><span>1</span></li><li class=\"radial\" id=\"radial2\"><span>2</span></li><li class=\"radial\" id=\"radial3\"><span>3</span></li><li class=\"radial\" id=\"radial4\"><span>4</span></li></ul></div>'    
    ...
    RadialController.prototype.handleChoice = function(deltaX, deltaY) {
      var choice = 0
    ...
    RadialController.prototype.showPass = function(password){
      // $('#position').html(pass)
